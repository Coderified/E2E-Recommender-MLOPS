...
#this is the class for data processing
#this will be used to process the data and save it in the required format
class DataProcessing:
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("The training-testing data as well as rating_df is saved now..")
        except Exception as e:
    ...
    def run(self):
        try:
            ...
            logger.info("Data Processing Pipeline ran sucesfully.............")
